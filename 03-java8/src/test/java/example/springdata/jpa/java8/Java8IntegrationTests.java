...
public class Java8IntegrationTests {
	...
	public void providesFindOneWithOptional() {
		...
		assertThat(repository.findOne(carter.getId()).isPresent(), is(true));
		assertThat(repository.findOne(carter.getId() + 1), is(Optional.<Customer> empty()));
	}
	...
	public void auditingSetsJdk8DateTimeTypes() {
		...
		assertThat(customer.getModifiedDate(), is(notNullValue()));
	}
